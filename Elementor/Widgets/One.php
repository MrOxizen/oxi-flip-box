...
class One extends Widget_Base {
    ...
    public function get_name() {
        return 'oxilab-flip-box';
    }

    public function get_title() {
        return esc_html__('Layouts One', OXI_FLIP_BOX_TEXTDOMAIN);
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .oxi-addons-flip-box-style-1 *' => 'transition-duration: {{SIZE}}s;',
                    ],
                ]
        );
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-front-section',
                ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
                'sa_flip_boxes_flip_image_ratio',
                [
                    'label' => esc_html__('Image Ratio', OXI_FLIP_BOX_TEXTDOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'size_units' => ['px', '%', 'em'],
                    'range' => [
                        'px' => [
        ...
        $this->add_responsive_control(
                'flip_boxes_flip_front_image_Radius',
                [
                    'label' => esc_html__('Image Radius', OXI_FLIP_BOX_TEXTDOMAIN),
                    'type' => Controls_Manager::DIMENSIONS,
                    'size_units' => ['px', '%', 'em'],
                    'range' => [
                        'px' => [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-front-image img' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
        );
        $this->end_controls_section();
        ...
        $this->add_responsive_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-front-image-icon i' => 'font-size:{{SIZE}}{{UNIT}};',
                    ],
                ]
        );
        $this->add_control(
        ...
        $this->add_group_control(
            ...
            'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
            'types' => ['none', 'classic', 'gradient', 'video'],
            'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-front-image-icon',
                ]
        );
        $this->add_group_control(
                Group_Control_Border::get_type(),
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-front-heading-data',
                ]
        );
        ...
        $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-back-section',
                ]
        );
        $this->add_group_control(
                Group_Control_Box_Shadow::get_type(), [
        ...
        $this->add_control(
                ...
                [
                    ...
                    'default' => '#6200EE',
                    'selectors' => [
                        '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data' => 'background-color: {{VALUE}};',
                    ],
                ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
                ...
                [
                    ...
                    'default' => '#6200EE',
                    'selectors' => [
                        '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover' => 'background-color: {{VALUE}};',
                    ],
                ]
        );
        $this->add_group_control(
                ...
                [
                    ...
                    'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-1 .oxi-addons-flip-box-back-button .oxi-addons-flip-box-back-button-data:hover',
                ]
        );
        $this->add_responsive_control(
    ...
    public function render() {
        ...
        wp_enqueue_style('oxilab-flip-box-one', OXI_FLIP_BOX_UPLOAD_URL . '/Elementor/assets/css/one.css', false, OXI_FLIP_BOX_PLUGIN_VERSION);
        ...
        echo '<div class="oxi-addons-flip-box-style-1">' . $bt . '
