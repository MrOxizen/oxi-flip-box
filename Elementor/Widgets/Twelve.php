...
class Twelve extends Widget_Base
{

    public function get_name()
    {
        return 'oxilab-flip-box-twelve';
    }

    public function get_title()
    {
        return esc_html__('Layouts Twelve', OXI_FLIP_BOX_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Info', OXI_FLIP_BOX_TEXTDOMAIN),
                'type' => Controls_Manager::TEXTAREA,
                'default' => 'It is a long have established fact that a readering is will be by the readable normal distribution let.',
            ]
        );
        $this->add_control(
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-12 *' => 'transition-duration: {{SIZE}}s; -moz-transition-duration: {{SIZE}}s; -webkit-transition-duration: {{SIZE}}s;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-front-section',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-front-icon i' => 'font-size:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#ffa200',
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-front-icon i' => 'color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
                'types' => ['none', 'classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-front-icon-box',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-front-headding',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-front-info',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
                'types' => ['none', 'classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-back-section',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'center',
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-back-headding' => 'align-self: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-back-headding',
            ]
        );
        ...
        $this->start_controls_section(
            'section_flip_back_head_border_style',
            [
                'label' => esc_html__('Back Heading Border Style', OXI_FLIP_BOX_TEXTDOMAIN),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_responsive_control(
            'section_flip_back_head_border_width',
            [
                'label' => esc_html__('Width', OXI_FLIP_BOX_TEXTDOMAIN),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_control(
            'section_flip_back_head_border_color',
            [
                'label' => esc_html__('Color', OXI_FLIP_BOX_TEXTDOMAIN),
                'type' => Controls_Manager::COLOR,
                'default' => '#ffa200',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Scheme_Typography::TYPOGRAPHY_3,
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-12 .oxi-addons-flip-box-back-info',
            ]
        );
    ...
    public function render()
    {
        ...
        wp_enqueue_style('oxilab-flip-box-twelve', OXI_FLIP_BOX_UPLOAD_URL . '/Elementor/assets/css/twelve.css', false, OXI_FLIP_BOX_PLUGIN_VERSION);
        $settings = $this->get_settings();
        $icon = $front_hadding = $front_info = $back_hadding = $backinfo = $bt = $bc = '';
        ...
        echo '<div class="oxi-addons-flip-box-style-12">
                ' . $bt . '
