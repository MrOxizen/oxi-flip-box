...
class Ten extends Widget_Base
{

    public function get_name()
    {
        return 'oxilab-flip-box-ten';
    }

    public function get_title()
    {
        return esc_html__('Layouts Ten', OXI_FLIP_BOX_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'Macs, PCs, tablets or phones and see up-to-date have financials. It’s online accountings softwares that’s simple.',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 *' => 'transition-duration: {{SIZE}}s; -moz-transition-duration: {{SIZE}}s; -webkit-transition-duration: {{SIZE}}s;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-front-section',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-front-icon i' => 'width:{{SIZE}}{{UNIT}}; height:{{SIZE}}{{UNIT}};  line-height:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-front-icon i' => 'font-size:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#be00cc',
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-front-icon i' => 'color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
                'types' => ['none', 'classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-front-icon i',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-front-icon i' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-front-headding',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
                'types' => ['none', 'classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-back-section',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-back-icon i' => 'width:{{SIZE}}{{UNIT}}; height:{{SIZE}}{{UNIT}}; line-height:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-back-icon i' => 'font-size:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#fff',
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-back-icon i' => 'color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
                'types' => ['none', 'classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-back-icon i',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-back-icon i' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-10 .oxi-addons-flip-box-back-info',
            ]
        );
    ...
    public function render()
    {
        ...
        wp_enqueue_style('oxilab-flip-box-ten', OXI_FLIP_BOX_UPLOAD_URL . '/Elementor/assets/css/ten.css', false, OXI_FLIP_BOX_PLUGIN_VERSION);
        $settings = $this->get_settings();
        $icon = $front_hadding = $backinfo = $backicon = $bt = $bc = '';
        ...
        echo '<div class="oxi-addons-flip-box-style-10">
                ' . $bt . '
