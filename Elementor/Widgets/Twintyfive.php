...
class Twintyfive extends Widget_Base {

    public function get_name() {
        return 'oxilab-flip-box-twintyfive';
    }

    public function get_title() {
        return esc_html__('Layouts Twintyfive', OXI_FLIP_BOX_TEXTDOMAIN);
    }
    ...
    public function render() {
        ...
        wp_enqueue_style('oxilab-flip-box-twintyfive', OXI_FLIP_BOX_UPLOAD_URL . '/Elementor/assets/css/twintyfive.css', false, OXI_FLIP_BOX_PLUGIN_VERSION);
