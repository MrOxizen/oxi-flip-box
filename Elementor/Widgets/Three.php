...
class Three extends Widget_Base
{

    public function get_name()
    {
        return 'oxilab-flip-box-three';
    }

    public function get_title()
    {
        return esc_html__('Layouts Three', OXI_FLIP_BOX_TEXTDOMAIN);
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-3 *' => 'transition-duration: {{SIZE}}s; -moz-transition-duration: {{SIZE}}s; -webkit-transition-duration: {{SIZE}}s;',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-section',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-icon i' => 'width:{{SIZE}}{{UNIT}}; height:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-icon i' => 'font-size:{{SIZE}}{{UNIT}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'default' => '#008299',
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-icon i' => 'color: {{VALUE}};'
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
                'types' => ['none', 'classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-icon i',
            ]
        );
        $this->add_group_control(
            Group_Control_Border::get_type(),
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-icon i' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        $this->add_responsive_control(
            'flip_boxes_flip_icon_front_padding',
            [
                'label' => esc_html__('Padding', OXI_FLIP_BOX_TEXTDOMAIN),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-headding',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'scheme' => Scheme_Typography::TYPOGRAPHY_1,
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-front-info',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __('Background', OXI_FLIP_BOX_TEXTDOMAIN),
                'types' => ['none', 'classic', 'gradient', 'video'],
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-back-section',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .oxi-addons-flip-box-style-3 .oxi-addons-flip-box-back-info',
            ]
        );
    ...
    public function render()
    {
        ...
        wp_enqueue_style('oxilab-flip-box-three', OXI_FLIP_BOX_UPLOAD_URL . '/Elementor/assets/css/three.css', false, OXI_FLIP_BOX_PLUGIN_VERSION);
        $settings = $this->get_settings();
        $icon = $front_hadding = $front_info = $backinfo = $starturl = $endurl = '';
        ...
        if ($settings['oxi_flip_backend_link']['url'] != '') {
            ...
            $starturl .= '<a ' . $this->get_render_attribute_string('oxi_flip_link') . '>';
            $endurl .= '</a>';
        }

        echo '<div class="oxi-addons-flip-box-style-3">' . $starturl . '
